...
const SingleDonation = ({donation, searchFor}) => {
    ...
    return (
        ...
        <div className="flex flex-col">
            ...
            <h4 style={{background: `${category_bg}`, color: `${text_button_bg}`}}  className=" w-20 rounded-lg text-center text-[14px]  font-medium grow">{category}</h4>
