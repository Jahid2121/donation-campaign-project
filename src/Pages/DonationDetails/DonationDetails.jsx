...
const DonationDetails = () => {
    ...
    return (
        <div className="md:ml-40 ml-8 mt-16 lg:w-[900px] relative" >
            <div className="bg-blend-overlay ">
            <img className="w-3/4" src={picture} alt="" />
            <div  className="bg-[#0B0B0B80] md:w-[675px] h-20 -mt-20 absolute overflow-hidden"></div>
            <button style={{background: `${text_button_bg}`}} onClick={handleDonation} className="btn relative text-white flex  -mt-16 ml-6">Donate ${price}</button>
